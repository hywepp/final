...
mongoose.connect(
  "mongodb+srv://ghostman:ghdud0306@cluster0.wkf6p.mongodb.net/cluster0?retryWrites=true&w=majority",
...
app.post(
  ...
  async (req, res) => {
    ...
    const asset = new Asset({ user, coin, quantity: 100000 });    // 회원가입을 하면 10만달러를 준다.
    await asset.save();
